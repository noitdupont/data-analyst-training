-- PostgreSQL version of Northwind database
-- To run this script:
-- 1. Connect to PostgreSQL: psql -d postgres
-- 2. Create database: CREATE DATABASE northwind;
-- 3. Connect to database: \c northwind
-- 4. Run this script: \i northwind_postgres.sql
...
INSERT INTO Customers VALUES(51,'Mère Paillarde','Jean Fresniére','43 rue St. Laurent','Montréal','H1J 1C3','Canada');
...
INSERT INTO Customers VALUES(62,'Queen Cozinha','Lúcia Carvalho','Alameda dos Canários, 891','São Paulo','05487-020','Brazil');
...
INSERT INTO Customers VALUES(83,'Vaffeljernet','Palle Ibsen','Smagslöget 45','Århus','8200','Denmark');
...
INSERT INTO Products VALUES(71,'Flötemysost',15,4,'10 - 500 g pkgs.',21.5);
...
-- Set the sequence values to the correct starting point
...
SELECT setval('employees_employeeid_seq', (SELECT MAX(employeeid) FROM employees));
...
SELECT setval('orderdetails_orderdetailid_seq', (SELECT MAX(orderdetailid) FROM orderdetails));
