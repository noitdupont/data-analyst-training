...
--     Create a new database named World.db.
--     Copy and paste the SQL below into the query window.
--     Execute the script to create the World database.
-- Or:
--     Run the following command in a terminal window.
--     mysql
--     Copy and paste the SQL below into the terminal window to create the World database.
