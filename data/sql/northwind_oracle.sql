-- Oracle User and Privilege Setup for Northwind Database
-- Run this as a DBA user (SYS or SYSTEM)

-- Create user
CREATE USER NORTHWIND IDENTIFIED BY northwind_password;
...
-- Grant tablespace quota (adjust size as needed)
...
-- Connect as the new user to create the schema
-- CONNECT NORTHWIND/northwind_password;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP SEQUENCE SHIPPERS_SEQ';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP SEQUENCE ORDERDETAILS_SEQ';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
...
CREATE TABLE ORDERS(
    ...
    CONSTRAINT FK_ORDERS_SHIPPER FOREIGN KEY (SHIPPERID) REFERENCES SHIPPERS (SHIPPERID)
);
...
FOR EACH ROW
BEGIN
    :NEW.CUSTOMERID := CUSTOMERS_SEQ.NEXTVAL;
END;
...
FOR EACH ROW
BEGIN
    :NEW.EMPLOYEEID := EMPLOYEES_SEQ.NEXTVAL;
END;

CREATE OR REPLACE TRIGGER TRG_SHIPPERS_ID
BEFORE INSERT ON SHIPPERS
FOR EACH ROW
BEGIN
    :NEW.SHIPPERID := SHIPPERS_SEQ.NEXTVAL;
END;
...
FOR EACH ROW
BEGIN
    :NEW.SUPPLIERID := SUPPLIERS_SEQ.NEXTVAL;
END;
...
CREATE OR REPLACE TRIGGER TRG_ORDERDETAILS_ID
BEFORE INSERT ON ORDERDETAILS
FOR EACH ROW
BEGIN
    :NEW.ORDERDETAILID := ORDERDETAILS_SEQ.NEXTVAL;
END;
...
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(1,'Davolio','Nancy',DATE '1968-12-08','EmpID1.pic','Education includes a BA in psychology from Colorado State University. She also completed (The Art of the Cold Call). Nancy is a member of ''Toastmasters International''.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(2,'Fuller','Andrew',DATE '1952-02-19','EmpID2.pic','Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(3,'Leverling','Janet',DATE '1963-08-30','EmpID3.pic','Janet has a BS degree in chemistry from Boston College). She has also completed a certificate program in food retailing management. Janet was hired as a sales associate and was promoted to sales representative.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(4,'Peacock','Margaret',DATE '1958-09-19','EmpID4.pic','Margaret holds a BA in English literature from Concordia College and an MA from the American Institute of Culinary Arts. She was temporarily assigned to the London office before returning to her permanent post in Seattle.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(5,'Buchanan','Steven',DATE '1955-03-04','EmpID5.pic','Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses ''Successful Telemarketing'' and ''International Sales Management''. He is fluent in French.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(6,'Suyama','Michael',DATE '1963-07-02','EmpID6.pic','Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses ''Multi-Cultural Selling'' and ''Time Management for the Sales Professional''. He is fluent in Japanese and can read and write French, Portuguese, and Spanish.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(7,'King','Robert',DATE '1960-05-29','EmpID7.pic','Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled ''Selling in Europe'', he was transferred to the London office.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(8,'Callahan','Laura',DATE '1958-01-09','EmpID8.pic','Laura received a BA in psychology from the University of Washington. She has also completed a course in business French. She reads and writes French.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(9,'Dodsworth','Anne',DATE '1969-07-02','EmpID9.pic','Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.');
INSERT INTO EMPLOYEES (EMPLOYEEID, LASTNAME, FIRSTNAME, BIRTHDATE, PHOTO, NOTES) VALUES(10,'West','Adam',DATE '1928-09-19','EmpID10.pic','An old chum.');
...
INSERT INTO SUPPLIERS (SUPPLIERID, SUPPLIERNAME, CONTACTNAME, ADDRESS, CITY, POSTALCODE, COUNTRY, PHONE) VALUES(19,'New England Seafood Cannery','Robb Merchant','Order Processing Dept. 2100 Paul Revere Blvd.','Boston','2134','USA','(617) 555-3267');
INSERT INTO SUPPLIERS (SUPPLIERID, SUPPLIERNAME, CONTACTNAME, ADDRESS, CITY, POSTALCODE, COUNTRY, PHONE) VALUES(20,'Leka Trading','Chandra Leka','471 Serangoon Loop, Suite #402','Singapore','512','Singapore','555-8787');
...
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10248,90,5,DATE '1996-07-04',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10249,81,6,DATE '1996-07-05',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10250,34,4,DATE '1996-07-08',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10251,84,3,DATE '1996-07-08',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10252,76,4,DATE '1996-07-09',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10253,34,3,DATE '1996-07-10',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10254,14,5,DATE '1996-07-11',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10255,68,9,DATE '1996-07-12',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10256,88,3,DATE '1996-07-15',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10257,35,4,DATE '1996-07-16',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10258,20,1,DATE '1996-07-17',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10259,13,4,DATE '1996-07-18',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10260,55,4,DATE '1996-07-19',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10261,61,4,DATE '1996-07-19',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10262,65,8,DATE '1996-07-22',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10263,20,9,DATE '1996-07-23',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10264,24,6,DATE '1996-07-24',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10265,7,2,DATE '1996-07-25',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10266,87,3,DATE '1996-07-26',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10267,25,4,DATE '1996-07-29',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10268,33,8,DATE '1996-07-30',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10269,89,5,DATE '1996-07-31',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10270,87,1,DATE '1996-08-01',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10271,75,6,DATE '1996-08-01',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10272,65,6,DATE '1996-08-02',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10273,63,3,DATE '1996-08-05',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10274,85,6,DATE '1996-08-06',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(
2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10362,9,3,DATE '1996-11-25',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10363,17,4,DATE '1996-11-26',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10364,19,1,DATE '1996-11-26',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10365,3,3,DATE '1996-11-27',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10366,29,8,DATE '1996-11-28',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10367,83,7,DATE '1996-11-28',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10368,20,2,DATE '1996-11-29',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10369,75,8,DATE '1996-12-02',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10370,14,6,DATE '1996-12-03',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10371,41,1,DATE '1996-12-03',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10372,62,5,DATE '1996-12-04',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10373,37,4,DATE '1996-12-05',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10374,91,1,DATE '1996-12-05',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10375,36,3,DATE '1996-12-06',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10376,51,1,DATE '1996-12-09',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10377,72,1,DATE '1996-12-09',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10378,24,5,DATE '1996-12-10',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10379,61,2,DATE '1996-12-11',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10380,37,8,DATE '1996-12-12',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10381,46,3,DATE '1996-12-12',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10382,20,4,DATE '1996-12-13',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10383,4,8,DATE '1996-12-16',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10384,5,3,DATE '1996-12-16',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10385,75,1,DATE '1996-12-17',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10386,21,9,DATE '1996-12-18',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10387,70,1,DATE '1996-12-18',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10388,72,2,DATE '1996-12-19',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10389,10,4,DATE '1996-12-20',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10390,20,6,DATE '1996-12-23',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10391,17,3,DATE '1996-12-23',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10392,59,2,DATE '1996-12-24',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10393,71,1,DATE '1996-12-25',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10394,36,1,DATE '1996-12-25',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10395,35,6,DATE '1996-12-26',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10396,25,1,DATE '1996-12-27',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10397,60,5,DATE '1996-12-27',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10398,71,2,DATE '1996-12-30',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10399,83,8,DATE '1996-12-31',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10400,19,1,DATE '1997-01-01',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10401,65,1,DATE '1997-01-01',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10402,20,8,DATE '1997-01-02',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10403,20,4,DATE '1997-01-03',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10404,49,2,DATE '1997-01-03',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10405,47,1,DATE '1997-01-06',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10406,62,7,DATE '1997-01-07',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10407,56,2,DATE '1997-01-07',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10408,23,8,DATE '1997-01-08',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10409,54,3,DATE '1997-01-09',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10410,10,3,DATE '1997-01-10',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10411,10,9,DATE '1997-01-10',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10412,87,8,DATE '1997-01-13',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10413,41,3,DATE '1997-01-14',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10414,21,2,DATE '1997-01-14',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10415,36,3,DATE '1997-01-15',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10416,87,8,DATE '1997-01-16',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10417,73,4,DATE '1997-01-16',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10418,63,4,DATE '1997-01-17',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10419,68,4,DATE '1997-01-20',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10420,88,3,DATE '1997-01-21',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10421,61,8,DATE '1997-01-21',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10422,27,2,DATE '1997-01-22',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10423,31,6,DATE '1997-01-23',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10424,51,7,DATE '1997-01-23',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10425,41,6,DATE '1997-01-24',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10426,29,4,DATE '1997-01-27',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10427,59,4,DATE '1997-01-27',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10428,66,7,DATE '1997-01-28',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10429,37,3,DATE '1997-01-29',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10430,20,4,DATE '1997-01-30',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10431,10,4,DATE '1997-01-30',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10432,75,3,DATE '1997-01-31',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10433,60,3,DATE '1997-02-03',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10434,24,3,DATE '1997-02-03',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10435,16,8,DATE '1997-02-04',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10436,7,3,DATE '1997-02-05',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10437,87,8,DATE '1997-02-05',1);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10438,79,3,DATE '1997-02-06',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10439,51,6,DATE '1997-02-07',3);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10440,71,4,DATE '1997-02-10',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10441,55,3,DATE '1997-02-10',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10442,20,3,DATE '1997-02-11',2);
INSERT INTO ORDERS (ORDERID, CUSTOMERID, EMPLOYEEID, ORDERDATE, SHIPPERID) VALUES(10443,66,8,DATE '1997-02-12',1);
...
SELECT 'Northwind database creation completed successfully!' AS STATUS FROM DUAL;