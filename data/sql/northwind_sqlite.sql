/*  -----------------------------------------------------------------------------------------------------------
    ...
    Import Data: sqlite3 northwind.db < northwind_sqlite.sql

    Query Data: sqlite3 northwind.db "SELECT CustomerID, CustomerName, City, Country FROM Customers LIMIT 10;"
    ---------------------------------------------------------------------------------------------------------- */
