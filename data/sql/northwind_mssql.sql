...
--     Copy and paste the SQL below into a new query window.
--     Execute the script to create the Northwind database.
-- Or:
--     Run the following command in sqlcmd.
--     Copy and paste the SQL below to create the Northwind database.
...
-- Insert Categories (need to use SET IDENTITY_INSERT ON/OFF for explicit ID values)
